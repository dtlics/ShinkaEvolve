...
Read: .claude/skills/shinka-orchestrator/SKILL.md (launch/wake sections), CLAUDE.md (standing role / unattended-run bullets), orchestrator/NOTES.md, and the memory note content quoted in EVIDENCE (main-loop-only).
Answer:
