...
| **Collapse** | outer Shinka repo merged into this submodule (tasks/, configs/, scripts/, .env, CLAUDE.md, .claude/skills/) so all work happens here | `collapsed-agent` (current) |
