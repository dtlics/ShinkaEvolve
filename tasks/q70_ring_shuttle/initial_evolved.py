...
NOT THE BEST SEED ANY MORE: since the 2b router repair the sibling seed
initial_folded.py lands at 300 rounds / +2.6565, just ahead of this one. The
two remain separate islands (different cell geometry, different family-change
convention); this file is still the one evaluate.py's SHIPPED_SEED_SCORE is
keyed to.
